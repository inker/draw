(window.webpackJsonp=window.webpackJsonp||[]).push([[4],{102:function(e,t,n){"use strict";n.r(t);var a=n(0),c=n.n(a),r=n(67),o=n(78),l=n(79),s=n(114),u=n(116),i=n(70),m=n(71),p=n(75),b=n(121),d=n(86),f=n(117),E=n(82),j=n(83),O=n(90),h=n(115),g=n(85),v=n(84);function w(e){return{currentMatchupNum:0,currentPotNum:1,possiblePairings:null,pots:e.map(e=>l(e)),matchups:r(16).map(()=>[])}}t.default=Object(a.memo)(({season:e,pots:t})=>{const[n,r]=Object(i.a)(),[l,y]=Object(m.a)(),N=Object(a.useMemo)(()=>Object(u.a)(e),[e]),[{currentMatchupNum:k,currentPotNum:P,possiblePairings:T,pots:x,matchups:M},S]=Object(a.useState)(()=>w(t));Object(a.useEffect)(()=>{S(w(t))},[t,n]);const G=Object(b.a)("(min-height: 750px)"),[R]=Object(p.a)(),A=Object(a.useRef)(null),$=Object(a.useCallback)(e=>{const t=x[P],n=T?T[e]:e,a=t[n],c=x.slice();c[P]=c[P].filter((e,t)=>t!==n);const r=M.slice();r[k]=[...r[k],a];const o=1===P?Object(s.a)(c,r,N):null;S({currentPotNum:1-P,currentMatchupNum:k-P+1,possiblePairings:o,pots:c,matchups:r})},[N,x,M,P,k,T]),F=()=>{if(l)return;(1===(null==T?void 0:T.length)||1===P&&1===x[1].length)&&$(0)};Object(a.useEffect)(()=>{setTimeout(F,250)},[P]);const I=Object(a.useMemo)(()=>T&&x[0].filter((e,t)=>T.includes(t)),[T]),z=k>=t[0].length;Object(a.useEffect)(()=>{if(l){const e=(null!=I?I:x[1]).length;if(e>0){const t=o(e-1);$(t)}}},[l,P]),Object(a.useEffect)(()=>{z&&l&&y(!1)},[z,l]);const C=T?T.map(e=>x[0][e]):[];return c.a.createElement(v.a,null,c.a.createElement(E.a,null,c.a.createElement(d.a,{selectedTeams:C,initialPots:t,pots:x,currentPotNum:P,split:!G}),c.a.createElement(f.a,{ref:A,matchups:M})),c.a.createElement(j.a,null,!l&&c.a.createElement(c.a.Fragment,null,!z&&c.a.createElement(h.a,null,"Runners-up"),c.a.createElement(O.a,{forceNoSelect:0===P,display:!z,displayTeams:R,selectedTeam:null,pot:x[1],onPick:$}),!z&&c.a.createElement(h.a,null,"Group Winners"),I&&c.a.createElement(O.a,{forceNoSelect:1===P,display:!z,displayTeams:R,selectedTeam:null,pot:I,onPick:$})),z&&c.a.createElement(g.a,{long:!1,completed:z,selectedTeam:null,pickedGroup:null,possibleGroups:null,numGroups:0,groupsElement:A,reset:r})))})},114:function(e,t,n){"use strict";function a(e,[t,n],c,r){const o=c.findIndex(e=>1===e.length);if(!r(e,c,o))return!1;const l=[...c],s=l[o][0];l[o]=[s,e];return o+1===l.length||function([e,t],n,c){const r=n.findIndex(e=>!e.length),[o,...l]=t,s=[...n];return s[r]=[o],e.some(t=>a(t,[e,l],s,c))}([t.filter(t=>t!==e),n],l,r)}t.a=([e,t],n,c)=>e.map((e,t)=>t).filter(r=>a(e[r],[e,t],n,c))},115:function(e,t,n){"use strict";const a=n(2).d.div`
  margin-top: 10px;
  margin-bottom: 5px;
  user-select: none;
...
`;var g=Object(a.memo)(({teams:e})=>{const[t,n]=null!=e?e:[];return c.a.createElement(l.a,null,c.a.createElement(O,{team:t}),c.a.createElement(s.a,null,c.a.createElement(h,null)),c.a.createElement(O,{team:n}))});const v=Object(r.d)(o.a)`
  width: auto;
  align-self: center;
  max-width: initial;
