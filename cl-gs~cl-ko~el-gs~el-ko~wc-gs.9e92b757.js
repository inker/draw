...
`;const T=(0,o.memo)((function({long:e,completed:t,selectedTeam:n,pickedGroup:r,possibleGroups:s,isDisplayPossibleGroupsText:d,numGroups:u,groupsElement:p,reset:x}){const h=(0,o.useRef)(null),g=(0,o.useRef)(null);(0,o.useEffect)((()=>{g.current=t?null:n}),[t,n]);const v=g.current??n;return t?(0,i.jsx)(P,{children:(0,i.jsxs)(E,{children:[(0,i.jsx)("div",{children:"Draw completed!"}),(0,i.jsx)(k,{completed:t,groupsElement:p}),(0,i.jsx)(a,{onClick:x,children:"Restart"})]})}):null!==r?(h.current=(0,i.jsx)(P,{children:(0,i.jsxs)("div",{children:[e&&v?(0,i.jsxs)("span",{children:[(0,i.jsx)(C,{children:v.shortName??v.name})," goes to group"]}):(0,i.jsx)("span",{children:"Group"})," ",(0,i.jsx)(C,{children:(0,m.Z)(r)}),"!"]})}),h.current):v?(0,i.jsx)(P,{children:d?(0,i.jsxs)("div",{children:["Possible groups for"," ",(0,i.jsxs)($,{children:[(0,i.jsx)(C,{children:v.name}),":"]}),s?(0,i.jsx)(f,{numGroups:u,possibleGroups:s}):(0,i.jsxs)("div",{children:[(0,i.jsx)(l.Z,{initialNum:0,maxNum:10,interval:2e3}),(0,i.jsx)(c,{delay:1e4,children:(0,i.jsx)(w,{})})]})]}):h.current}):(0,i.jsx)(P,{children:"Pick a ball"})}))},90604:(e,t,n)=>{n.d(t,{Z:()=>i});const i=n(12788).ZP.div`
  display: flex;
  flex-direction: column;
  margin: 0 5px 10px;
  min-width: 35%;
...
`},10694:(e,t,n)=>{n.d(t,{Z:()=>y});var i=n(85893),o=n(67294),r=n(12788),s=n(58020),d=n(14293),a=n.n(d),l=n(68020);let c;var m=n(73935),u=n(12988);const p=(0,o.memo)((({tagName:e,modalRoot:t,children:n})=>{const i=(0,o.useMemo)((()=>{const t=u.includes(e)&&"svg"!==e?"http://www.w3.org/1999/xhtml":"http://www.w3.org/2000/svg";return document.createElementNS(t,e)}),[e,t]),r=(0,o.useRef)(i);return(0,o.useEffect)((()=>(t.appendChild(i),()=>{t.removeChild(i)})),[]),m.createPortal(n,r.current)})),x=((e,...t)=>{c||(c=document.createElement("style"),document.head.appendChild(c));const n=(0,l.Z)("styled-element-"),i=((e,...t)=>e.reduce(((e,n,i)=>`${e}${n}${a()(t[i])?"":t[i]}`),""))(e,...t);return c.textContent+=`.${n}{${i}}`,n})`
  ...
  z-index: 1000;
  pointer-events: none;
`,h=document.createElement("div");h.classList.add(x),document.body.insertBefore(h,document.getElementById("app"));const f=(0,o.memo)((function({children:e}){return(0,i.jsx)(p,{tagName:"div",modalRoot:h,children:e})}));var g=n(39548);const w=(0,r.ZP)(g.Z)`
  position: fixed;
  top: 0;
  left: 0;
  z-index: 1000;
  ...
  user-select: none;
  pointer-events: none;
`,v=e=>"string"==typeof e?document.querySelector(e):e.current,b=e=>`transform ${e}ms ease-in-out`;function Z(e){const{left:t,top:n}=e.getBoundingClientRect();return`translate3d(${t}px, ${n}px, 0px)`}const y=(0,o.memo)((function({from:e,to:t,duration:n,team:r,onAnimationEnd:d}){const a=(0,o.useMemo)((()=>v(e)),[e]),l=(0,o.useMemo)((()=>v(t)),[t]),[c,m]=(0,o.useState)(a);(0,o.useLayoutEffect)((()=>{c===a&&m(l)}),[c]);const u=(0,o.useMemo)((()=>({transform:c instanceof HTMLElement?Z(c):"",transition:c===l?b(n):""})),[c,l,n]),p=(0,o.useCallback)((e=>{"transform"===e.propertyName&&d?.()}),[d]);return c&&(0,i.jsx)(f,{children:(0,i.jsx)(w,{country:(0,s.Z)(r),style:u,onTransitionEnd:p,children:r.shortName??r.name})})}))},85973:(e,t,n)=>{n.d(t,{Z:()=>i});const i=n(12788).ZP.div`
  display: flex;
  margin: auto;
  width: 1000px;
