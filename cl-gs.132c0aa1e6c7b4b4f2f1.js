/*! For license information please see cl-gs.132c0aa1e6c7b4b4f2f1.js.LICENSE.txt */
...
`;var g=Object(n.c)(p.a)`
  ${e=>e.possible&&f}
  ${e=>e.picked&&h}
`,k=a(68),w=e=>{var t;return null!==(t=e.country)&&void 0!==t?t:e.name in k?e.name:void 0};var O=Object(r.memo)(({maxTeams:e,groupLetter:t,teams:a,potNum:r,possible:n,airborneTeams:o,background:p,color:m})=>{const b=c(a,o);return s.a.createElement(i.a,null,s.a.createElement(u.a,{background:p,color:m},"Group"," ",t),s.a.createElement(d.a,null,b.map(e=>{var t;return s.a.createElement(g,{country:w(e),picked:!0},null!==(t=e.shortName)&&void 0!==t?t:e.name)}),l(b.length,e).map(e=>s.a.createElement(g,{key:e,possible:e===r&&n,"data-cellid":`${t}${e}`}))))});const j=n.c.div`
  display: flex;
  flex-flow: row wrap;
...
`,v=Object(r.forwardRef)(({maxTeams:e,currentPotNum:t,groups:a,possibleGroups:r,airborneTeams:n,groupColors:c},l)=>s.a.createElement(j,{ref:l},null==a?void 0:a.map((l,i)=>{const u=Object(o.a)(i),d=c&&c[~~(i/a.length*c.length)];return s.a.createElement(O,{key:u,maxTeams:e,groupLetter:u,teams:l,potNum:t,possible:!!(null==r?void 0:r.includes(i)),airborneTeams:n,background:d})})));t.a=Object(r.memo)(v)},80:function(e,t,a){"use strict";var r=a(0),s=a(67),n=a.n(s);const o={key:null,isTimedOut:!1},c="TIMEOUT_VALUE_SET",l="TIMEOUT_RESET";function i(e,t){switch(t.type){case c:return{key:t.payload,isTimedOut:!!t.payload&&t.payload===e.key};case l:return o;default:throw new Error("Unknown action: "+t)}}t.a=e=>{const[t,a]=Object(r.useReducer)(i,o),s=async t=>{a({type:c,payload:t}),await n()(e),a({type:c,payload:t})},u=()=>{a({type:l})},d=Object(r.useMemo)(()=>({set:s,reset:u}),[]);return[t.isTimedOut,d]}},92:function(e,t,a){e.exports=function(){return new Worker(a.p+"39c14fef1a2da90bd9f7.worker.js")}},99:function(e,t,a){"use strict";a.r(t);var r=a(0),s=a.n(r),n=a(69),o=a(2),c=a(61),l=a(63),i=a(79),u=a(80),d=a(76),p=a(59),m=a(77),b=a(75),f=a(78),h=a(71),g=a(72),k=a(81),w=a(1),O=a(123);var j=Object(w.c)(O.a)`
  &:hover {
...
`;var y=Object(r.memo)(({display:e,displayGroups:t,possibleGroups:a,onPick:n})=>{const o=Object(r.useCallback)(e=>{const t=e.target,a=+t.dataset.group;if(Number.isNaN(a))throw new TypeError("Incorrect group ball: "+t.dataset.group);n(a)},[n]);return s.a.createElement(v,null,e&&(null==a?void 0:a.map(e=>s.a.createElement(j,{key:e,"data-group":e,forceVisible:t,onClick:o},Object(p.a)(e)))))}),E=a(74),T=a(73),G=a(92),P=a.n(G);const x=["rgba(255, 0, 0, 0.25)","rgba(0, 128, 255, 0.25)"];function N(e){return{currentPotNum:0,selectedTeam:null,pickedGroup:null,hungPot:e[0],possibleGroups:null,possibleGroupsShuffled:null}}t.default=Object(r.memo)(({season:e,pots:t})=>{const[a,w]=Object(c.a)(),O=Object(r.useMemo)(()=>t.map(e=>n(e)),[t,a]),j=Object(r.useMemo)(()=>t[0].map(()=>[]),[t,a]),[{currentPotNum:v,selectedTeam:G,pickedGroup:M,hungPot:A,possibleGroups:C,possibleGroupsShuffled:I},$]=Object(r.useState)(()=>N(O));Object(r.useEffect)(()=>{$(N(O))},[O]);const[,S]=Object(o.a)(),[R]=Object(l.a)(),W=Object(d.a)(P.a),[U,D]=Object(i.a)(),[L,_]=Object(u.a)(3e3),J=Object(r.useRef)(null),V=Object(r.useCallback)(async t=>(await W({season:e,pots:O,groups:j,selectedTeam:t})).possibleGroups,[O,j,e,W]),H=Object(r.useCallback)(async e=>{if(G)return;const t=O[v];if(!t[e])return;const a=t.splice(e,1)[0];_.set(a);const r=await V(a);_.reset(),$({currentPotNum:v,hungPot:t.slice(),selectedTeam:a,possibleGroups:r,possibleGroupsShuffled:n(r),pickedGroup:null})},[O,j,v,V]),q=Object(r.useCallback)(e=>{if(!G)return void S({error:"No selected team..."});j[e].push(G);const t=O[v].length>0?v:v+1;D.add(G),$({selectedTeam:null,pickedGroup:e,hungPot:O[t],possibleGroups:null,possibleGroupsShuffled:null,currentPotNum:t})},[O,j,G,v]),z=v>=O.length;return s.a.createElement(T.a,null,s.a.createElement(h.a,null,s.a.createElement(b.a,{selectedTeams:G&&[G],initialPots:t,pots:O,currentPotNum:v}),s.a.createElement(f.a,{ref:J,maxTeams:O.length,currentPotNum:v,groups:j,possibleGroups:C,airborneTeams:U,groupColors:x})),s.a.createElement(g.a,null,s.a.createElement(k.a,{display:!z,displayTeams:R,selectedTeam:G,pot:A,onPick:H}),s.a.createElement(E.a,{long:!1,calculating:L,completed:z,isAirborneAnimation:U.length>0,selectedTeam:G,pickedGroup:M,possibleGroups:C,numGroups:j.length,groupsElement:J.current,reset:w}),s.a.createElement(y,{display:!z,displayGroups:R,possibleGroups:I,onPick:q})),U.map(e=>{const t=j.findIndex(t=>t.includes(e)),a=Object(p.a)(t),r=j[t].indexOf(e);return s.a.createElement(m.a,{key:e.id,from:`[data-cellid='${e.id}']`,to:`[data-cellid='${a}${r}']`,duration:350,data:e,onAnimationEnd:D.remove})}))})}},0,[79]]);