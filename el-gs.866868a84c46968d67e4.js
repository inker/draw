...
`,G=(0,n.ZP)(d.Z)`
  ${e=>e.possible&&w}
  ${e=>e.picked&&P}
`;const T=(0,r.memo)((function({team:e,possible:o}){const s=(0,p.Z)(e),[a,l]=(0,r.useState)(e),[c,u]=(0,r.useState)(!1),i=(0,r.useContext)(n.Ni),d=(0,r.useRef)(null),b=(0,r.useCallback)((()=>u(!1)),[]),k=(0,r.useCallback)((()=>{l(e),u(!0)}),[e]);return(0,m.Z)((()=>{b()}),[i]),(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(G,{picked:c&&!!a,possible:o,onAnimationEnd:b,children:a?(0,t.jsx)(h.Z,{country:(0,f.Z)(a),children:a.shortName??a.name}):(0,t.jsx)(g.Z,{ref:d})}),e&&e!==s&&(0,t.jsx)(x.Z,{from:`[data-cellid='${e.id}']`,to:d,duration:350,team:e,onAnimationEnd:k})]})}));const v=(0,r.memo)((function({maxTeams:e,groupLetter:o,teams:s,potNum:r,possible:n,headerStyles:a}){return(0,t.jsxs)(c.Z,{children:[(0,t.jsx)("thead",{children:(0,t.jsx)(i.Z,{children:(0,t.jsx)(d.Z,{children:(0,t.jsxs)(u.Z,{styles:a,children:["Group"," ",o]})})})}),(0,t.jsx)("tbody",{children:l(e).map((e=>(0,t.jsx)(i.Z,{children:(0,t.jsx)(T,{team:s[e],possible:e===r&&n})},e)))})]})})),y=n.ZP.div`
  display: flex;
  flex-flow: row wrap;
...
`,N=(0,r.forwardRef)((({maxTeams:e,currentPotNum:o,groups:s,possibleGroups:r,getGroupHeaderStyles:n},l)=>(0,t.jsx)(y,{ref:l,children:s?.map(((s,l)=>{const c=(0,a.Z)(l),u=n?.(l);return(0,t.jsx)(v,{maxTeams:e,groupLetter:c,teams:s,potNum:o,possible:!!r?.includes(l),headerStyles:u},c)}))}))),$=(0,r.memo)(N)}}]);