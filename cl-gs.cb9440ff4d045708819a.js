...
`,j=Object(r.forwardRef)(({maxTeams:e,currentPotNum:t,groups:a,possibleGroups:r,airborneTeams:n,groupColors:c},l)=>s.a.createElement(O,{ref:l},null==a?void 0:a.map((l,i)=>{const u=Object(o.a)(i),d=null==c?void 0:c[~~(i/a.length*c.length)];return s.a.createElement(v,{key:u,maxTeams:e,groupLetter:u,teams:l,potNum:t,possible:!!(null==r?void 0:r.includes(i)),airborneTeams:n,background:d})})));t.a=Object(r.memo)(j)},79:function(e,t,a){"use strict";var r=a(0),s=a(66),n=a.n(s);const o={key:null,isTimedOut:!1},c="TIMEOUT_VALUE_SET",l="TIMEOUT_RESET";function i(e,t){switch(t.type){case c:return{key:t.payload,isTimedOut:!!t.payload&&t.payload===e.key};case l:return o;default:throw new Error("Unknown action: "+t)}}t.a=e=>{const[t,a]=Object(r.useReducer)(i,o),s=async t=>{a({type:c,payload:t}),await n()(e),a({type:c,payload:t})},u=()=>{a({type:l})},d=Object(r.useMemo)(()=>({set:s,reset:u}),[]);return[t.isTimedOut,d]}},92:function(e,t,a){"use strict";a.r(t),t.default=function(){return new Worker(a.p+"worker.fb2cda85fa295a811ddc.worker.js")}},99:function(e,t,a){"use strict";a.r(t);var r=a(0),s=a.n(r),n=a(68),o=a(2),c=a(61),l=a(63),i=a(78),u=a(79),d=a(75),p=a(59),m=a(76),b=a(74),f=a(77),h=a(70),g=a(71),k=a(80),w=a(1),v=a(123);var O=Object(w.c)(v.a)`
  &:hover {
