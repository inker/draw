(window.webpackJsonp=window.webpackJsonp||[]).push([["cl-gs","cl-gs-worker"],{394:function(e,t,a){"use strict";var o=a(0),r=a.n(o),s=a(4),n=a(381),c=a(400),l=a(111),u=a(383),i=a(401),p=a(388),d=a(385);const m=s.c`
  from {
...
`;t.a=Object(o.memo)(({maxTeams:e,currentPotNum:t,groups:a,possibleGroups:o,airborneTeams:s,groupColors:c})=>r.a.createElement(y,null,null==a?void 0:a.map((l,u)=>{const i=Object(n.a)(u),p=c&&c[~~(u/a.length*c.length)];return r.a.createElement(O,{key:i,maxTeams:e,groupLetter:i,teams:l,potNum:t,possible:!!(null==o?void 0:o.includes(u)),airborneTeams:s,background:p})})))},397:function(e,t,a){"use strict";var o=a(0),r=a(112),s=a.n(r);const n={key:null,isTimedOut:!1},c="TIMEOUT_VALUE_SET",l="TIMEOUT_RESET";function u(e,t){switch(t.type){case c:return{key:t.payload,isTimedOut:!!t.payload&&t.payload===e.key};case l:return n;default:throw new Error("Unknown action: "+t)}}t.a=e=>{const[t,a]=Object(o.useReducer)(u,n),r=async t=>{a({type:c,payload:t}),await s()(e),a({type:c,payload:t})},i=()=>{a({type:l})},p=Object(o.useMemo)(()=>({set:r,reset:i}),[]);return[t.isTimedOut,p]}},398:function(e,t,a){"use strict";var o=a(0),r=a(115),s=a(113),n=a.n(s);var c=class{constructor(e,t){this.asyncManager=new r.a,this.timeout=t,this.worker=e,this.worker.onmessage=e=>{const{messageId:t,data:a}=e.data;this.asyncManager.resolve(t,a)}}sendAndReceive(e){const t=this.asyncManager.getPromiseWithId(t=>{this.worker.postMessage({messageId:t,data:e})});return void 0===this.timeout?t:n()(t,this.timeout)}terminate(){this.worker.terminate()}};t.a=e=>{const t=Object(o.useMemo)(()=>new c(new e,12e4),[]);return Object(o.useEffect)(()=>()=>{t.terminate()},[]),Object(o.useCallback)(t.sendAndReceive.bind(t),[t])}},403:function(e,t,a){e.exports=function(){return new Worker(a.p+"5d06340687ad72821b0d.worker.js")}},410:function(e,t,a){"use strict";a.r(t);var o=a(0),r=a.n(o),s=a(387),n=a(12),c=a(384),l=a(396),u=a(397),i=a(398),p=a(382),d=a(381),m=a(393),b=a(392),f=a(394),g=a(389),k=a(390),h=a(399),w=a(4),O=a(426);var y=Object(w.b)(O.a)`
  &:hover {
