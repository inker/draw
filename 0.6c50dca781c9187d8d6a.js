(window.webpackJsonp=window.webpackJsonp||[]).push([[0],{467:function(e,t,n){"use strict";t.a=e=>String.fromCharCode(65+e)},469:function(e,t,n){"use strict";const a=n(4).b.div`
...
`;t.a=a},473:function(e,t,n){"use strict";const a=n(4).b.div`
  display: flex;
  margin: auto;
  width: 1000px;
...
`;t.a=a},474:function(e,t,n){"use strict";var a=n(0),r=n.n(a),o=n(484),i=n(4);var l=i.b.div`
  display: flex;
  flex-flow: row wrap;
  flex-wrap: nowrap;
...
`,c=n(469),s=n(480);var d=Object(i.b)(s.a)`
...
`;t.a=Object(a.memo)(({forceNoSelect:e,display:t,displayTeams:n,pot:o,selectedTeam:i,onPick:s})=>{const d=Object(a.useCallback)(e=>{const t=e.target,n=o.findIndex(e=>e.id===t.dataset.teamid);s(n,o)},[o,s]),u=e||i;return r.a.createElement(c,null,t&&o.map(t=>{var a;return r.a.createElement(l,{key:t.id,"data-teamid":t.id,selected:t===i,notSelected:e||!!i&&t!==i,forceVisible:n,noHover:!!u,onClick:u?void 0:d},null!==(a=t.shortName)&&void 0!==a?a:t.name)}))})},480:function(e,t,n){"use strict";const a=n(4).b.div`
  border: #aaa solid 1px;
  margin: 0px 5px 10px 5px;
  width: 150px;
  min-width: 0;
...
`;t.a=a},481:function(e,t,n){"use strict";var a=n(4),r=n(498),o=n(470);var i=Object(a.b)(o.a)`
  padding-left: 3px;
  padding-right: 3px;
  text-align: left;
...
`,c=Object(a.b)(l)`
  ...
  `}
`;t.a=c},484:function(e,t,n){var a=n(500),r=n(503),o=n(71),i=n(505),l=o((function(e,t){return i(e)?a(e,r(t,1,i,!0)):[]}));e.exports=l},485:function(e,t,n){"use strict";var a=n(4),r=n(470);const o=Object(a.b)(r.a)`
  justify-content: center;
  font-weight: 600;
  background-color: ${e=>e.background};
  color: ${e=>e.color};
`;t.a=o},494:function(e,t,n){"use strict";var a=n(4);var r=a.b.div`
  display: flex;
...
`;t.a=o},499:function(e,t){e.exports=function(e){return null==e}},500:function(e,t,n){var a=n(73),r=n(501),o=n(502),i=n(28),l=n(41),c=n(74);e.exports=function(e,t,n,s){var d=-1,u=r,m=!0,p=e.length,f=[],b=t.length;if(!p)return f;n&&(t=i(t,l(n))),s?(u=o,m=!1):t.length>=200&&(u=c,m=!1,t=new a(t));e:for(;++d<p;){var g=e[d],h=null==n?g:n(g);if(g=s||0!==g?g:0,m&&h==h){for(var x=b;x--;)if(t[x]===h)continue e;f.push(g)}else u(t,h,s)||f.push(g)}return f}},501:function(e,t,n){var a=n(72);e.exports=function(e,t){return!!(null==e?0:e.length)&&a(e,t,0)>-1}},502:function(e,t){e.exports=function(e,t,n){for(var a=-1,r=null==e?0:e.length;++a<r;)if(n(t,e[a]))return!0;return!1}},503:function(e,t,n){var a=n(75),r=n(504);e.exports=function e(t,n,o,i,l){var c=-1,s=t.length;for(o||(o=r),l||(l=[]);++c<s;){var d=t[c];n>0&&o(d)?n>1?e(d,n-1,o,i,l):a(l,d):i||(l[l.length]=d)}return l}},504:function(e,t,n){var a=n(20),r=n(43),o=n(6),i=a?a.isConcatSpreadable:void 0;e.exports=function(e){return o(e)||r(e)||!!(i&&e&&e[i])}},505:function(e,t,n){var a=n(42),r=n(12);e.exports=function(e){return r(e)&&a(e)}},506:function(e,t,n){"use strict";var a=n(0);var r=class{constructor(){this.callbacks=new Map}add(e,t){this.callbacks.set(e,t)}addAndGetId(e){const t=Math.random().toString(36).slice(2);return this.add(t,e),t}resolve(e,t){this.getCallbackAndDelete(e)(null,t)}reject(e,t){this.getCallbackAndDelete(e)(t)}getCallbackAndDelete(e){const t=this.callbacks.get(e);if(!t)throw new Error("no resolver with id = "+e);return this.callbacks.delete(e),t}};const o=(e,t)=>(n,a)=>{n?t(n):e(a)};var i=class{constructor(){this.manager=new r}getPromise(e){return new Promise(async(t,n)=>{const a=o(t,n);this.manager.add(e,a)})}getPromiseWithId(e){return new Promise(async(t,n)=>{const a=o(t,n),r=this.manager.addAndGetId(a);e&&e(r)})}resolve(e,t){this.manager.resolve(e,t)}reject(e,t){this.manager.reject(e,t)}},l=n(196),c=n.n(l);var s=class{constructor(e,t){this.asyncManager=new i,this.timeout=t,this.worker=e,this.worker.onmessage=e=>{const{messageId:t,data:n}=e.data;this.asyncManager.resolve(t,n)}}sendAndReceive(e){const t=this.asyncManager.getPromiseWithId(t=>{this.worker.postMessage({messageId:t,data:e})});return void 0===this.timeout?t:c()(t,this.timeout)}terminate(){this.worker.terminate()}};t.a=e=>{const t=Object(a.useMemo)(()=>new s(new e,12e4),[]);return Object(a.useEffect)(()=>()=>{t.terminate()},[]),Object(a.useCallback)(t.sendAndReceive.bind(t),[t])}},507:function(e,t,n){"use strict";var a=n(0),r=n.n(a),o=n(4),i=n(467),l=n(484),c=n(193),s=n(480),d=n(485),u=n(469),m=n(481);const p=o.c`
  from {
