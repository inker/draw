(window.webpackJsonp=window.webpackJsonp||[]).push([[2],{104:function(e,t,n){"use strict";function a(e,[t,n],r,o){const c=r.findIndex(e=>1===e.length);if(!o(e,r,c))return!1;const i=[...r],s=i[c][0];i[c]=[s,e];return c+1===i.length||function([e,t],n,r){const o=n.findIndex(e=>!e.length),[c,...i]=t,s=[...n];return s[o]=[c],e.some(t=>a(t,[e,i],s,r))}([t.filter(t=>t!==e),n],i,o)}t.a=([e,t],n,r)=>e.map((e,t)=>t).filter(o=>a(e[o],[e,t],n,r))},105:function(e,t){e.exports=function(){return!0}},106:function(e,t,n){"use strict";const a=n(1).c.div`
  margin-top: 10px;
  margin-bottom: 5px;
  user-select: none;
