/*! For license information please see cl-gs~cl-ko~el-gs~el-ko~wc-gs.e4eb706dc95fa772a266.js.LICENSE.txt */
...
`,s=n(22);var u=Object(r.memo)((({children:e,delay:t})=>(e=>{const[t,n]=Object(r.useState)(!1);return Object(r.useEffect)((()=>{const t=setTimeout((()=>{n(!0)}),e);return()=>{clearTimeout(t)}}),[]),t})(t)?o.a.createElement(o.a.Fragment,null,e):null)),d=n(80),p=n(73);var m=a.e.div`
  display: flex;
  justify-content: center;
  align-items: center;
...
`;const w=n.e(83).then(n.bind(null,542)),j=()=>({downloadClicked:null,transitionsEnabled:!0});var E=Object(r.memo)((({completed:e,groupsElement:t})=>{const[{downloadClicked:n,transitionsEnabled:a},i]=Object(r.useState)(j),c=Object(r.useCallback)((e=>{i({downloadClicked:e,transitionsEnabled:!1})}),[i]);Object(r.useEffect)((()=>{(async()=>{if(n){try{const e=t.current;if(!e)throw new Error("groups element is null");await x()(0);const r=await w;await r.default(e,n)}catch(e){console.error(e)}c(null)}})()}),[n]),Object(r.useEffect)((()=>{e||i({downloadClicked:null,transitionsEnabled:!0})}),[e]);const s=Object(r.useCallback)((()=>c("png")),[c]),u=Object(r.useCallback)((()=>c("svg")),[c]);return e&&t?o.a.createElement("div",null,!a&&o.a.createElement(y,null),"Download as ",o.a.createElement(l,{onClick:s},"PNG"),", ",o.a.createElement(l,{onClick:u},"SVG")):null}));const O=a.e.div`
  width: 100%;
  font-size: 1.25em;
  line-height: 150%;
...
`,y=a.d`
  filter: grayscale(0.5);
  opacity: 0.4;
`;var w=Object(a.e)(v.a)`
  ${e=>e.selected&&x}
  ${e=>e.picked&&y}
`;var j=Object(r.memo)((({teams:e,pickedTeams:t,selectedTeams:n})=>o.a.createElement(s.a,null,e.map((e=>{var r;const{name:a,country:i,shortName:c,pairing:l}=e;return o.a.createElement(g,{key:e.id},o.a.createElement(w,{"data-cellid":e.id,title:l&&"paired with "+(null!==(r=l.shortName)&&void 0!==r?r:l.name),selected:!!(null==n?void 0:n.includes(e)),picked:t.includes(e),country:null!=i?i:a},null!=c?c:a))})))));var E=Object(r.memo)((({isCurrent:e,potNum:t,teams:n,pickedTeams:r,selectedTeams:a,numCols:i,headerStyles:c})=>{const d=n.length/i;return o.a.createElement(p,{highlighted:e},o.a.createElement("thead",null,o.a.createElement(s.a,null,o.a.createElement(u.a,{colSpan:i},o.a.createElement(h,{highlighted:e,depleted:!n||r.length===n.length,styles:c},"Pot ",t+1)))),o.a.createElement("tbody",null,l(d).map((e=>{const t=e*i,c=l(i).map((e=>n[t+e]));return o.a.createElement(j,{key:c.map((e=>e.id)).join(":"),teams:c,selectedTeams:a,pickedTeams:r})}))))}));const O=a.d`
  background-color: rgba(0, 0, 0, 0.75);
  color: #fff;
`;t.a=Object(r.memo)((({initialPots:e,pots:t,selectedTeams:n,currentPotNum:r,split:a})=>o.a.createElement(c,{limitWidth:!a},e.map(((c,l)=>{const s=l===r,u=i(e[l],t[l],null!=n?n:[]);return o.a.createElement(E,{key:c[0].id,potNum:l,isCurrent:s,teams:c,pickedTeams:u,selectedTeams:n,numCols:a?2:1,headerStyles:O})})))))},94:function(e,t,n){"use strict";var r=n(0);Object.create;Object.create;function o(e,t){if(!t.has(e))throw new TypeError("attempted to get private field on non-instance");return t.get(e)}var a=class{constructor(){this.callbacks=new Map}add(e,t){this.callbacks.set(e,t)}addAndGetId(e){const t=Math.random().toString(36).slice(2);return this.add(t,e),t}resolve(e,t){this.getCallbackAndDelete(e)(null,t)}reject(e,t){this.getCallbackAndDelete(e)(t)}getCallbackAndDelete(e){const t=this.callbacks.get(e);if(!t)throw new Error("no resolver with id = "+e);return this.callbacks.delete(e),t}};const i=(e,t)=>(n,r)=>{n?t(n):e(r)};var c,l,s=class{constructor(){this.manager=new a}getPromise(e){return new Promise((async(t,n)=>{const r=i(t,n);this.manager.add(e,r)}))}getPromiseWithId(e){return new Promise((async(t,n)=>{const r=i(t,n),o=this.manager.addAndGetId(r);e&&e(o)}))}resolve(e,t){this.manager.resolve(e,t)}reject(e,t){this.manager.reject(e,t)}};c=new WeakMap,l=new WeakMap;var u=class{constructor(e){c.set(this,void 0),l.set(this,new s),function(e,t,n){if(!t.has(e))throw new TypeError("attempted to set private field on non-instance");t.set(e,n)}(this,c,e),o(this,c).onmessage=e=>{const{messageId:t,data:n}=e.data;o(this,l).resolve(t,n)}}sendAndReceive(e){return o(this,l).getPromiseWithId((t=>{o(this,c).postMessage({messageId:t,data:e})}))}terminate(){o(this,c).terminate()}};t.a=e=>{const t=Object(r.useMemo)((()=>new u(new e)),[e]);return Object(r.useEffect)((()=>()=>{t.terminate()}),[t]),Object(r.useCallback)(t.sendAndReceive.bind(t),[t])}},96:function(e,t,n){"use strict";var r=n(0),o=n.n(r),a=n(2),i=n(81),c=n(466),l=n(128);let s;var u=n(18),d=n.n(u),p=n(467),m=n.n(p);var f=Object(r.memo)((({tagName:e,modalRoot:t,children:n})=>{const o=Object(r.useMemo)((()=>{const t=m.a.includes(e)&&"svg"!==e?"http://www.w3.org/1999/xhtml":"http://www.w3.org/2000/svg";return document.createElementNS(t,e)}),[e,t]),a=Object(r.useRef)(o);return Object(r.useEffect)((()=>(t.appendChild(o),()=>{t.removeChild(o)})),[]),d.a.createPortal(n,a.current)}));const b=((e,...t)=>{s||(s=document.createElement("style"),document.head.appendChild(s));const n=Object(l.a)("styled-element-"),r=((e,...t)=>e.reduce(((e,n,r)=>`${e}${n}${c(t[r])?"":t[r]}`),""))(e,...t);return s.textContent+=`.${n}{${r}}`,n})`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
