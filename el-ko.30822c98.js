"use strict";(self.webpackChunkdraw=self.webpackChunkdraw||[]).push([[6349],{27045:(e,t,s)=>{s.r(t),s.d(t,{default:()=>C});var l=s(85893),n=s(67294),r=s(21225),i=s(96446),a=s(80676),o=s(40339),u=s(27603),c=s(56285),d=s(43761),m=s(12185),p=s(43510),h=s(72723),Z=s(11726),f=s(31294),x=s(85704),j=s(18753),g=s(40410),b=s(98514),k=s(86590);let w=()=>new Worker(new URL(s.p+s.u(7074),s.b));function y(e,t){return{currentMatchupNum:0,currentPotNum:1,possiblePairings:null,pots:e.map(e=>(0,r.Z)(e)),matchups:(0,i.Z)(t<2021?16:8).map(()=>[])}}function P({season:e,pots:t}){let[s,r]=(0,u.Z)(),[i,P]=(0,c.Z)(),[{currentMatchupNum:C,currentPotNum:N,possiblePairings:E,pots:v,matchups:T},M]=(0,n.useState)(()=>y(t,e));(0,n.useEffect)(()=>{M(y(t,e))},[t,e,s]);let R=(0,m.Z)("(min-height: 750px)"),[,S]=(0,o.Z)(),[$]=(0,d.Z)(),F=(0,p.Z)(w),G=(0,n.useRef)(null),A=(0,n.useCallback)(async(t,s)=>{try{let l=await F({season:e,pots:t,matchups:s});return l.possiblePairings}catch(e){throw S({error:"Could not determine possible pairings"}),e}},[e,F]),D=(0,n.useCallback)(async e=>{let t=v[N],s=E?E[e]:e,l=t[s],n=v.slice();n[N]=n[N].filter((e,t)=>t!==s);let r=T.slice();r[C]=[...r[C],l];let i=1===N?await A(n,r):null,a=C-N+1;M({currentPotNum:1-N,currentMatchupNum:a,possiblePairings:i,pots:n,matchups:r})},[v,T,N,C,E]),W=()=>{if(i)return;let e=E?.length===1||1===N&&1===v[1].length;e&&D(0)};(0,n.useEffect)(()=>{setTimeout(W,250)},[N]);let L=(0,n.useMemo)(()=>E&&v[0].filter((e,t)=>E.includes(t)),[E]),U=C>=t[0].length;(0,n.useEffect)(()=>{if(i){let e=L??v[1],t=e.length;if(t>0){let e=(0,a.Z)(t-1);D(e)}}},[i,N]),(0,n.useEffect)(()=>{U&&i&&P(!1)},[U,i]);let q=E?E.map(e=>v[0][e]):[];return(0,l.jsxs)(h.Z,{children:[(0,l.jsxs)(x.Z,{children:[(0,l.jsx)(Z.Z,{selectedTeams:q,initialPots:t,pots:v,currentPotNum:N,split:!R&&e<2021}),(0,l.jsx)(f.Z,{ref:G,matchups:T})]}),(0,l.jsxs)(j.Z,{children:[!i&&(0,l.jsxs)(l.Fragment,{children:[!U&&(0,l.jsx)(b.Z,{children:"Runners-up"}),(0,l.jsx)(g.Z,{forceNoSelect:0===N,display:!U,displayTeams:$,selectedTeam:null,pot:v[1],onPick:D}),!U&&(0,l.jsx)(b.Z,{children:"Group Winners"}),L&&(0,l.jsx)(g.Z,{forceNoSelect:1===N,display:!U,displayTeams:$,selectedTeam:null,pot:L,onPick:D})]}),U&&(0,l.jsx)(k.Z,{long:!1,completed:U,selectedTeam:null,pickedGroup:null,possibleGroups:null,numGroups:0,groupsElement:G,reset:r})]})]})}let C=(0,n.memo)(P)},31294:(e,t,s)=>{s.d(t,{Z:()=>E});var l=s(85893),n=s(67294),r=s(12788),i=s(46202),a=s(1850),o=s(8360),u=s(73995),c=s(90595),d=s(63835),m=s(63494),p=s(79633),h=s(88834),Z=s(43955);let f=r.F4`
  from {
