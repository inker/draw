...
`,j=n.iv`
  ...
  &::before {
    ...
    width: 100%;
    height: 100%;
    animation: ${e=>e.theme.isDarkMode?v:b} 1s ease;
    ${e=>e.theme.isDarkMode?n.iv`
      background-color: rgba(255, 255, 255, 0.3);
    `:n.iv`
      box-shadow: 0 0 5px #6af;
...
`,P=(0,n.ZP)(c.Z)`
  ${e=>e.possible&&j}
  ${e=>e.picked&&w}
`,G=(0,r.memo)((({team:e,possible:o})=>{var s;const i=(0,p.Z)(e),[l,a]=(0,r.useState)(e),[d,u]=(0,r.useState)(!1),c=(0,r.useContext)(n.Ni),b=(0,r.useRef)(null),v=(0,r.useCallback)((()=>u(!1)),[]),k=(0,r.useCallback)((()=>{a(e),u(!0)}),[e]);return(0,m.Z)((()=>{v()}),[c]),(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(P,Object.assign({picked:d&&!!l,possible:o,onAnimationEnd:v},{children:l?(0,t.jsx)(h.Z,Object.assign({country:(0,f.Z)(l)},{children:null!==(s=l.shortName)&&void 0!==s?s:l.name}),void 0):(0,t.jsx)(g.Z,{ref:b},void 0)}),void 0),e&&e!==i&&(0,t.jsx)(x.Z,{from:`[data-cellid='${e.id}']`,to:b,duration:350,team:e,onAnimationEnd:k},void 0)]},void 0)})),T=(0,r.memo)((({maxTeams:e,groupLetter:o,teams:s,potNum:r,possible:n,headerStyles:i})=>(0,t.jsxs)(a.Z,{children:[(0,t.jsx)("thead",{children:(0,t.jsx)(u.Z,{children:(0,t.jsx)(c.Z,{children:(0,t.jsxs)(d.Z,Object.assign({styles:i},{children:["Group"," ",o]}),void 0)},void 0)},void 0)},void 0),(0,t.jsx)("tbody",{children:l(e).map((e=>(0,t.jsx)(u.Z,{children:(0,t.jsx)(G,{team:s[e],possible:e===r&&n},void 0)},e)))},void 0)]},void 0))),y=n.ZP.div`
  display: flex;
  flex-flow: row wrap;
