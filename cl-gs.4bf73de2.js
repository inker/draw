...
`;function N(e){let r=e.map(e=>(0,i.Z)(e)),l=r[0];return{currentPotNum:0,selectedTeam:null,pickedGroup:null,hungPot:l,possibleGroups:null,possibleGroupsShuffled:null,pots:r,groups:e[0].map(()=>[])}}let T=(0,o.memo)(function({season:e,pots:r,isFirstPotShortDraw:l}){let[t,k]=(0,c.Z)(),[j,w]=(0,d.Z)(),[{currentPotNum:G,selectedTeam:T,pickedGroup:D,hungPot:M,possibleGroups:S,possibleGroupsShuffled:F,pots:R,groups:A},L]=(0,o.useState)(()=>N(r));(0,o.useEffect)(()=>{L(N(r))},[r,t]);let[,U]=(0,u.Z)(),[W]=(0,p.Z)(),H=(0,f.Z)(C),I=(0,f.Z)(y),V=(0,o.useRef)(null),q=l&&0===G,z=j||q,B=async()=>{let r;if(!T)throw Error("no selected team");try{if(q){let l=await H({season:e,pots:R,groups:A,selectedTeam:T});r=[l.pickedGroup]}else{let l=await I({season:e,pots:R,groups:A,selectedTeam:T});r=l.possibleGroups}}catch(e){console.error(e),U({error:"Could not determine the group"});return}L({selectedTeam:T,pickedGroup:null,hungPot:M,currentPotNum:G,possibleGroups:r,possibleGroupsShuffled:(0,i.Z)(r),pots:R,groups:A})},J=(0,o.useCallback)(e=>{if(T)return;let r=R[G][e];if(!r)return;let l=R.slice();l[G]=l[G].filter((r,l)=>l!==e),L({currentPotNum:G,hungPot:M,selectedTeam:r,possibleGroups:S,possibleGroupsShuffled:F,pickedGroup:null,pots:l,groups:A})},[R,A,G,M,T,S,F]),K=(0,o.useCallback)(e=>{if(!T){U({error:"No selected team..."});return}let r=A.slice();r[e]=[...r[e],T];let l=R[G].length>0?G:G+1;L({selectedTeam:null,pickedGroup:e,hungPot:R[l],possibleGroups:null,possibleGroupsShuffled:null,currentPotNum:l,pots:R,groups:r})},[R,A,T,G,M]);(0,o.useEffect)(()=>{T&&B()},[T]);let O=G>=R.length;(0,o.useEffect)(()=>{let e=M?.length;if(j&&e){let r=(0,n.Z)(e-1);J(r)}},[j,M]),(0,o.useEffect)(()=>{if(z&&F?.length){let e=q?Math.min(...F):(0,a.Z)(F);K(e)}},[z,F]),(0,o.useEffect)(()=>{O&&j&&w(!1)},[O,j]);let Q=A.length,X=(0,o.useCallback)(e=>e<Q>>1?P:E,[Q]);return(0,s.jsxs)(m.Z,{children:[(0,s.jsxs)(x.Z,{children:[(0,s.jsx)(h.Z,{selectedTeams:T&&[T],initialPots:r,pots:R,currentPotNum:G}),(0,s.jsx)(b.Z,{ref:V,maxTeams:R.length,currentPotNum:G,groups:A,possibleGroups:z?null:S,getGroupHeaderStyles:X})]}),(0,s.jsxs)(g.Z,{children:[!j&&(0,s.jsx)(Z.Z,{display:!O,displayTeams:W,selectedTeam:T,pot:M,onPick:J}),(0,s.jsx)(v.Z,{long:!1,completed:O,selectedTeam:T,pickedGroup:D,possibleGroups:j?null:S,isDisplayPossibleGroupsText:!!T,numGroups:Q,groupsElement:V,reset:k}),!z&&(0,s.jsx)($,{display:!O,displayGroups:W,possibleGroups:F,onPick:K})]})]})})},80528:(e,r,l)=>{l.d(r,{Z:()=>P});var s=l(85893),o=l(67294),t=l(70394),i=l(40726),n=l(46202),a=l(48606),u=l(1850),c=l(8360),d=l(90595),p=l(63835),f=l(63494),m=l(79633),h=l(88834),b=l(43955);let x=(0,t.F4)`
  from {
