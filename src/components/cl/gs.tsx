...
export default class extends PureComponent<Props, State> {
  ...
  render() {
    ...
    return (
      <div>
        <div id="tables-div">
          <div id="pots-div">{!completed && pots &&
            pots.map((pot, i) => (
              <Pot
                potNum={i}
                teams={pot.map(team => ({
          ...
          <div id="groups-div">{!completed && groups &&
            groups.map((group, i) => (
              <Group
        ...
        <div id="bowls-div">
          ...
          >{!completed && pots &&
            pots[currentPotNum].map((team, i) => (
              <div
                className={classNames('ball', {
                  'ball-picked': team === pickedTeam,
                })}
                data-team={i}
          ...
          <div id="announcement">
              ...
              {
                completed && <a onClick={e => this.reset()}>Restart</a>
              }
          </div>
          <div id="group-bowl" className="bowl">{!completed && possibleGroups &&
