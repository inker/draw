...
`,g=(0,s.ZP)(p)`
  ...
  align-items: center;
`,j=(0,n.memo)(function({noAnimation:e,children:t}){return(0,a.jsxs)("div",{children:[(0,a.jsx)(w,{$animate:!e}),(0,a.jsx)(g,{children:t})]})}),Text=s.ZP.div`
  font-size: 5vw;
...
`,k=(0,n.memo)(function({noAnimation:e,children:t}){return(0,a.jsx)(j,{noAnimation:e,children:(0,a.jsx)(Text,{children:t})})});var b=r(4871);let y=(0,n.memo)(function(){let[e]=(0,c.Z)(),{initial:t,error:r,waiting:i}=e,s=(0,n.useCallback)(e=>(0,a.jsx)(k,{...e,noAnimation:t}),[t]);return r?(0,a.jsx)(s,{children:r}):i?(0,a.jsxs)(s,{children:["wait",(0,a.jsx)(b.Z,{initialNum:3,maxNum:3,interval:1e3})]}):null}),S=(0,n.lazy)((0,o.Z)(Promise.all([r.e(870),r.e(7770)]).then(r.bind(r,55323)))),z=s.ZP.div`
  * {
    box-sizing: border-box;
  }
`,$=(0,n.memo)(function(){let[e,t]=(0,c.Z)(),r=h();return(0,n.useEffect)(()=>{e.initial&&!e.waiting&&t({initial:!1})},[e.waiting]),(0,a.jsxs)(s.f6,{theme:r?x:f,children:[(0,a.jsx)(v,{}),(0,a.jsxs)(z,{children:[(0,a.jsx)(y,{}),(0,a.jsx)(l.UT,{children:(0,a.jsx)(n.Suspense,{children:(0,a.jsx)(S,{})})})]})]})}),M=document.getElementById("app"),C=(0,i.s)(M);C.render((0,a.jsx)($,{}))},21487:(e,t,r)=>{r.d(t,{Z:()=>s});var a=r(67294),i=r(37728);let n=(0,i.Z)({initial:!0,waiting:!0,error:null}),s=()=>{let[e,t]=n(),r=(0,a.useCallback)(e=>{t(t=>({...t,...e}))},[t]);return[e,r]}},65600:(e,t,r)=>{r.d(t,{Z:()=>s});var a=r(69203),i=r(10659);let n=["light","dark","auto"],s=(0,i.Z)("store:theme","light",{parse:a.Z,serialize:a.Z,validate:e=>n.includes(e)})},4871:(e,t,r)=>{r.d(t,{Z:()=>l});var a=r(85893),i=r(67294),n=r(70394);let s=n.ZP.span`
  opacity: 0;
