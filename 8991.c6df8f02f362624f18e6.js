...
`},78893:(e,t,r)=>{"use strict";r.d(t,{Z:()=>w});var n=r(85893),o=r(67294),i=r(58804),s=r(58020),a=r(14293);let c;var d=r(73935),l=r(12988);const u=(0,o.memo)((({tagName:e,modalRoot:t,children:r})=>{const n=(0,o.useMemo)((()=>{const t=l.includes(e)&&"svg"!==e?"http://www.w3.org/1999/xhtml":"http://www.w3.org/2000/svg";return document.createElementNS(t,e)}),[e,t]),i=(0,o.useRef)(n);return(0,o.useEffect)((()=>(t.appendChild(n),()=>{t.removeChild(n)})),[]),d.createPortal(r,i.current)})),p=((e,...t)=>{c||(c=document.createElement("style"),document.head.appendChild(c));const r=((e="")=>`${e}${Math.random().toString(36).slice(2)}`)("styled-element-"),n=((e,...t)=>e.reduce(((e,r,n)=>`${e}${r}${a(t[n])?"":t[n]}`),""))(e,...t);return c.textContent+=`.${r}{${n}}`,r})`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
