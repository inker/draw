/*! For license information please see cl-gs.c66b60d0d5dc01605f77.js.LICENSE.txt */
(window.webpackJsonp=window.webpackJsonp||[]).push([[1,6],{101:function(e,t,a){"use strict";a.r(t);var r=a(0),s=a.n(r),n=a(1),o=a(70),l=a(2),c=a(63),i=a(66),u=a(80),d=a(81),m=a(77),p=a(61),b=a(78),f=a(76),h=a(79),g=a(72),w=a(73),k=a(82),y=a(126);var v=Object(n.d)(y.a)`
  &:hover {
...
`,T=Object(r.forwardRef)(({maxTeams:e,currentPotNum:t,groups:a,possibleGroups:r,airborneTeams:n,getGroupHeaderStyles:l},c)=>s.a.createElement(E,{ref:c},null==a?void 0:a.map((a,c)=>{const i=Object(o.a)(c),u=null==l?void 0:l(c);return s.a.createElement(j,{key:i,maxTeams:e,groupLetter:i,teams:a,potNum:t,possible:!!(null==r?void 0:r.includes(c)),airborneTeams:n,headerStyles:u})})));t.a=Object(r.memo)(T)},81:function(e,t,a){"use strict";var r=a(0),s=a(68),n=a.n(s);const o={key:null,isTimedOut:!1},l="TIMEOUT_VALUE_SET",c="TIMEOUT_RESET";function i(e,t){switch(t.type){case l:return{key:t.payload,isTimedOut:!!t.payload&&t.payload===e.key};case c:return o;default:throw new Error("Unknown action: "+t)}}t.a=e=>{const[t,a]=Object(r.useReducer)(i,o),s=async t=>{a({type:l,payload:t}),await n()(e),a({type:l,payload:t})},u=()=>{a({type:c})},d=Object(r.useMemo)(()=>({set:s,reset:u}),[]);return[t.isTimedOut,d]}},94:function(e,t,a){"use strict";a.r(t),t.default=function(){return new Worker(a.p+"worker.b28e9dece7ba7c38f3a9.worker.js")}}},0,[80]]);