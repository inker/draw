...
`;t.a=r},70:function(e,t,n){"use strict";const r=n(2).d.tr`
  border: ${e=>e.theme.border};
`;t.a=r},71:function(e,t,n){"use strict";var r=n(2),o=n(126),a=n(96);const i=Object(r.d)(a.a)`
...
`,l=n(67),s=n(70),u=n(66),d=n(72);var p=Object(a.d)(d.a)`
...
`;t.a=Object(r.memo)(({initialPots:e,pots:t,selectedTeams:n,currentPotNum:r,split:a})=>o.a.createElement(c,{limitWidth:!a},e.map((c,l)=>{const s=l===r,u=i(e[l],t[l],null!=n?n:[]);return o.a.createElement(E,{key:c[0].id,potNum:l,isCurrent:s,teams:c,pickedTeams:u,selectedTeams:n,numCols:a?2:1,headerStyles:O})})))},87:function(e,t,n){"use strict";var r=n(0);Object.create;Object.create;function o(e,t){if(!t.has(e))throw new TypeError("attempted to get private field on non-instance");return t.get(e)}function a(e,t,n){if(!t.has(e))throw new TypeError("attempted to set private field on non-instance");return t.set(e,n),n}var i=class{constructor(){this.callbacks=new Map}add(e,t){this.callbacks.set(e,t)}addAndGetId(e){const t=Math.random().toString(36).slice(2);return this.add(t,e),t}resolve(e,t){this.getCallbackAndDelete(e)(null,t)}reject(e,t){this.getCallbackAndDelete(e)(t)}getCallbackAndDelete(e){const t=this.callbacks.get(e);if(!t)throw new Error("no resolver with id = "+e);return this.callbacks.delete(e),t}};const c=(e,t)=>(n,r)=>{n?t(n):e(r)};var l,s,u,d=class{constructor(){this.manager=new i}getPromise(e){return new Promise(async(t,n)=>{const r=c(t,n);this.manager.add(e,r)})}getPromiseWithId(e){return new Promise(async(t,n)=>{const r=c(t,n),o=this.manager.addAndGetId(r);e&&e(o)})}resolve(e,t){this.manager.resolve(e,t)}reject(e,t){this.manager.reject(e,t)}},p=n(451),m=n.n(p);l=new WeakMap,s=new WeakMap,u=new WeakMap;var f=class{constructor(e,t){l.set(this,void 0),s.set(this,new d),u.set(this,void 0),a(this,u,t),a(this,l,e),o(this,l).onmessage=e=>{const{messageId:t,data:n}=e.data;o(this,s).resolve(t,n)}}sendAndReceive(e){const t=o(this,s).getPromiseWithId(t=>{o(this,l).postMessage({messageId:t,data:e})});return void 0===o(this,u)?t:m()(t,o(this,u))}terminate(){o(this,l).terminate()}};t.a=(e,t)=>{const n=Object(r.useMemo)(()=>new f(new e,t),[e,t]);return Object(r.useEffect)(()=>()=>{n.terminate()},[n]),Object(r.useCallback)(n.sendAndReceive.bind(n),[n])}},89:function(e,t,n){"use strict";var r=n(0),o=n.n(r),a=n(2),i=n(74),c=n(464),l=n(123);let s;var u=n(15),d=n.n(u),p=n(465),m=n.n(p);var f=Object(r.memo)(({tagName:e,modalRoot:t,children:n})=>{const o=Object(r.useMemo)(()=>{const t=m.a.includes(e)&&"svg"!==e?"http://www.w3.org/1999/xhtml":"http://www.w3.org/2000/svg";return document.createElementNS(t,e)},[e,t]),a=Object(r.useRef)(o);return Object(r.useEffect)(()=>(t.appendChild(o),()=>{t.removeChild(o)}),[]),d.a.createPortal(n,a.current)});const b=((e,...t)=>{s||(s=document.createElement("style"),document.head.appendChild(s));const n=Object(l.a)("styled-element-"),r=((e,...t)=>e.reduce((e,n,r)=>`${e}${n}${c(t[r])?"":t[r]}`,""))(e,...t);return s.textContent+=`.${n}{${r}}`,n})`
  ...
  z-index: 1000;
  pointer-events: none;
`,h=document.createElement("div");h.classList.add(b),document.body.insertBefore(h,document.getElementById("app"));var g=Object(r.memo)(({children:e})=>o.a.createElement(f,{tagName:"div",modalRoot:h},e)),v=n(71);const x=Object(a.d)(v.a)`
  position: fixed;
  top: 0;
  left: 0;
  margin: 0;
...
`;t.a=Object(r.memo)(({forceNoSelect:e,display:t,displayTeams:n,pot:a,selectedTeam:i,onPick:s})=>{const u=Object(r.useCallback)(e=>{const t=e.target,n=a.findIndex(e=>e.id===t.dataset.teamid);s(n,a)},[a,s]),d=e||i;return o.a.createElement(l,null,t&&a.map(t=>{var r;return o.a.createElement(c,{key:t.id,"data-teamid":t.id,selected:t===i,notSelected:e||!!i&&t!==i,forceVisible:n,noHover:!!d,onClick:d?void 0:u},null!==(r=t.shortName)&&void 0!==r?r:t.name)}))})},95:function(e,t,n){"use strict";var r=n(2),o=n(132);const a=Object(r.d)(o.a)`
  justify-content: center;
  height: 100%;
  width: 100%;
  font-weight: 600;
  ${e=>e.styles};
`;t.a=a},96:function(e,t,n){"use strict";var r=n(2),o=n(132);const a=Object(r.d)(o.a)`
  margin: 0 3px;
  text-align: left;
