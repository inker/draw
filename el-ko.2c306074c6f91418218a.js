(window.webpackJsonp=window.webpackJsonp||[]).push([[4],{104:function(e,t,n){"use strict";function a(e,[t,n],r,o){const c=r.findIndex(e=>1===e.length);if(!o(e,r,c))return!1;const i=[...r],l=i[c][0];i[c]=[l,e];return c+1===i.length||function([e,t],n,r){const o=n.findIndex(e=>!e.length),[c,...i]=t,l=[...n];return l[o]=[c],e.some(t=>a(t,[e,i],l,r))}([t.filter(t=>t!==e),n],i,o)}t.a=([e,t],n,r)=>e.map((e,t)=>t).filter(o=>a(e[o],[e,t],n,r))},105:function(e,t){e.exports=function(){return!0}},106:function(e,t,n){"use strict";const a=n(1).b.div`
  margin-top: 10px;
  margin-bottom: 5px;
  user-select: none;
