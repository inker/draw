...
`,f=(0,o.memo)((({numGroups:e,possibleGroups:t})=>{const r=e>>1;return(0,n.jsx)(h,{children:p(e).map((e=>{const o=(0,u.Z)(e);return(0,n.jsx)(m,Object.assign({color:e<r?"red":"blue",possible:t.includes(e)},{children:o}),o)}))},void 0)})),v=i.ZP.div`
  ...
  padding: 10px;
`,x=(0,o.memo)((()=>(0,n.jsxs)(v,{children:[(0,n.jsx)("div",{children:"Calculation is taking too long."},void 0),(0,n.jsxs)("div",{children:["And"," ",(0,n.jsx)(s.Z,Object.assign({href:"https://github.com/inker/draw/issues/14",target:"_blank",rel:"noopener"},{children:"here's why"}),void 0),"."]},void 0)]},void 0)));var g=r(26962),b=r.n(g);const j=i.vJ`
  body * {
    transition-property: none !important;
    animation: none !important;
  }
`,y=r.e(2154).then(r.bind(r,39816)),w=()=>({downloadClicked:null,transitionsEnabled:!0}),Z=(0,o.memo)((({completed:e,groupsElement:t})=>{const[{downloadClicked:r,transitionsEnabled:i},s]=(0,o.useState)(w),a=(0,o.useCallback)((e=>{s({downloadClicked:e,transitionsEnabled:!1})}),[s]);(0,o.useEffect)((()=>{(async()=>{if(r){try{const e=t.current;if(!e)throw new Error("groups element is null");await b()(0);const n=await y;await n.default(e,r)}catch(e){console.error(e)}a(null)}})()}),[r]),(0,o.useEffect)((()=>{e||s({downloadClicked:null,transitionsEnabled:!0})}),[e]);const c=(0,o.useCallback)((()=>a("png")),[a]),l=(0,o.useCallback)((()=>a("svg")),[a]);return e&&t?(0,n.jsxs)("div",{children:[!i&&(0,n.jsx)(j,{},void 0),"Download as ",(0,n.jsx)(d,Object.assign({onClick:c},{children:"PNG"}),void 0),", ",(0,n.jsx)(d,Object.assign({onClick:l},{children:"SVG"}),void 0)]},void 0):null})),k=i.ZP.div`
  width: 100%;
  font-size: 1.25em;
  line-height: 150%;
...
`},19992:(e,t,r)=>{"use strict";r.d(t,{Z:()=>y});var n=r(85893),o=r(67294),i=r(29163),s=r(64982),a=r(14293),d=r(46087);let c;var l=r(73935),u=r(12988);const p=(0,o.memo)((({tagName:e,modalRoot:t,children:r})=>{const n=(0,o.useMemo)((()=>{const t=u.includes(e)&&"svg"!==e?"http://www.w3.org/1999/xhtml":"http://www.w3.org/2000/svg";return document.createElementNS(t,e)}),[e,t]),i=(0,o.useRef)(n);return(0,o.useEffect)((()=>(t.appendChild(n),()=>{t.removeChild(n)})),[]),l.createPortal(r,i.current)})),m=((e,...t)=>{c||(c=document.createElement("style"),document.head.appendChild(c));const r=(0,d.Z)("styled-element-"),n=((e,...t)=>e.reduce(((e,r,n)=>`${e}${r}${a(t[n])?"":t[n]}`),""))(e,...t);return c.textContent+=`.${r}{${n}}`,r})`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
  ...
  z-index: 1000;
  pointer-events: none;
`,h=document.createElement("div");h.classList.add(m),document.body.insertBefore(h,document.getElementById("app"));const f=(0,o.memo)((({children:e})=>(0,n.jsx)(p,Object.assign({tagName:"div",modalRoot:h},{children:e}),void 0)));var v=r(930);const x=(0,i.ZP)(v.Z)`
  position: fixed;
  top: 0;
  left: 0;
  margin: 0;
  ...
  user-select: none;
  pointer-events: none;
`,g=e=>"string"==typeof e?document.querySelector(e):e.current,b=e=>`transform ${e}ms ease-in-out`;function j(e){const{left:t,top:r}=e.getBoundingClientRect();return`translate3d(${t}px, ${r}px, 0px)`}const y=(0,o.memo)((({from:e,to:t,duration:r,team:i,onAnimationEnd:a})=>{var d;const c=(0,o.useMemo)((()=>g(e)),[e]),l=(0,o.useMemo)((()=>g(t)),[t]),[u,p]=(0,o.useState)(c);(0,o.useLayoutEffect)((()=>{u===c&&p(l)}),[u]);const m=(0,o.useMemo)((()=>({transform:u instanceof HTMLElement?j(u):"",transition:u===l?b(r):""})),[u,l,r]),h=(0,o.useCallback)((e=>{"transform"===e.propertyName&&(null==a||a())}),[a]);return u&&(0,n.jsx)(f,{children:(0,n.jsx)(x,Object.assign({country:(0,s.Z)(i),style:m,onTransitionEnd:h},{children:null!==(d=i.shortName)&&void 0!==d?d:i.name}),void 0)},void 0)}))},31080:(e,t,r)=>{"use strict";r.d(t,{Z:()=>n});const n=r(29163).ZP.div`
  display: flex;
  margin: auto;
  width: 1000px;
...
`},1245:(e,t,r)=>{"use strict";r.d(t,{Z:()=>P});var n=r(85893),o=r(67294),i=r(29163),s=r(91966);const a=i.ZP.div`
  display: flex;
  flex-flow: row wrap;
  flex-wrap: nowrap;
  justify-content: center;
...
`;var d=r(96026),c=r(68398),l=r(24729),u=r(42048);const p=(0,i.ZP)(u.Z)`
  transform: box-shadow 1s linear;
  ${e=>e.highlighted&&"\n  "}
`;var m=r(13963);const h=i.iv`
...
`},24729:(e,t,r)=>{"use strict";r.d(t,{Z:()=>n});const n=r(29163).ZP.td`
  height: 20px;
  padding: 0;
...
`},97256:(e,t,r)=>{"use strict";r.d(t,{Z:()=>i});var n=r(29163),o=r(49634);const i=(0,n.ZP)(o.Z)`
  margin: 0 3px;
  text-align: left;
...
`},930:(e,t,r)=>{"use strict";r.d(t,{Z:()=>a});var n=r(29163),o=r(52482),i=r(97256);const s=(0,n.ZP)(i.Z)`
...
`,a=(0,n.ZP)(s)`
  ...
  `}
`},93749:(e,t,r)=>{"use strict";r.d(t,{Z:()=>i});var n=r(29163),o=r(97256);const i=(0,n.ZP)(o.Z)`
  visibility: hidden;
  pointer-events: none;
...
`},13963:(e,t,r)=>{"use strict";r.d(t,{Z:()=>i});var n=r(29163),o=r(49634);const i=(0,n.ZP)(o.Z)`
  justify-content: center;
  height: 100%;
  width: 100%;
  font-weight: 600;
  ${e=>e.styles}
`},68398:(e,t,r)=>{"use strict";r.d(t,{Z:()=>n});const n=r(29163).ZP.tr`
  border: ${e=>e.theme.border};
`},42048:(e,t,r)=>{"use strict";r.d(t,{Z:()=>n});const n=r(29163).ZP.table`
  table-layout: fixed;
  border-left: ${e=>e.theme.border};
...
`},80737:(e,t,r)=>{"use strict";r.d(t,{Z:()=>n});const n=e=>String.fromCharCode(65+e)},64982:(e,t,r)=>{"use strict";r.d(t,{Z:()=>o});var n=r(89105);const o=e=>{var t;return null!==(t=e.country)&&void 0!==t?t:e.name in n.Z?e.name:void 0}},86893:(e,t,r)=>{"use strict";r.d(t,{Z:()=>o});var n=r(67294);const o=(e,t)=>{const r=(0,n.useRef)(!1);(0,n.useEffect)((()=>{r.current?e():r.current=!0}),t)}},72935:(e,t,r)=>{"use strict";r.d(t,{Z:()=>o});var n=r(67294);const o=e=>{const t=(0,n.useRef)();return(0,n.useEffect)((()=>{t.current=e})),t.current}},43887:(e,t,r)=>{"use strict";r.d(t,{Z:()=>u});var n=r(67294);Object.create;Object.create;function o(e,t){if(!t.has(e))throw new TypeError("attempted to get private field on non-instance");return t.get(e)}const i=class{constructor(){this.callbacks=new Map}add(e,t){this.callbacks.set(e,t)}addAndGetId(e){const t=Math.random().toString(36).slice(2);return this.add(t,e),t}resolve(e,t){this.getCallbackAndDelete(e)(null,t)}reject(e,t){this.getCallbackAndDelete(e)(t)}getCallbackAndDelete(e){const t=this.callbacks.get(e);if(!t)throw new Error(`no resolver with id = ${e}`);return this.callbacks.delete(e),t}},s=(e,t)=>(r,n)=>{r?t(r):e(n)};const a=class{constructor(){this.manager=new i}getPromise(e){return new Promise((async(t,r)=>{const n=s(t,r);this.manager.add(e,n)}))}getPromiseWithId(e){return new Promise((async(t,r)=>{const n=s(t,r),o=this.manager.addAndGetId(n);e&&e(o)}))}resolve(e,t){this.manager.resolve(e,t)}reject(e,t){this.manager.reject(e,t)}};var d,c;d=new WeakMap,c=new WeakMap;const l=class{constructor(e){d.set(this,void 0),c.set(this,new a),function(e,t,r){if(!t.has(e))throw new TypeError("attempted to set private field on non-instance");t.set(e,r)}(this,d,e),o(this,d).onmessage=e=>{const{messageId:t,data:r}=e.data;o(this,c).resolve(t,r)}}sendAndReceive(e){return o(this,c).getPromiseWithId((t=>{o(this,d).postMessage({messageId:t,data:e})}))}terminate(){o(this,d).terminate()}},u=e=>{const t=(0,n.useMemo)((()=>new l(new e)),[e]);return(0,n.useEffect)((()=>()=>{t.terminate()}),[t]),(0,n.useCallback)(t.sendAndReceive.bind(t),[t])}}}]);