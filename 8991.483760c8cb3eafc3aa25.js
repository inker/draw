...
`,f=i.ZP.div`
  ...
  justify-content: center;
  margin-top: 2px;
`;const x=(0,o.memo)((function({numGroups:e,possibleGroups:t}){const r=e>>1;return(0,n.jsx)(f,{children:m()(e).map((e=>{const o=(0,u.Z)(e);return(0,n.jsx)(h,{color:e<r?"red":"blue",possible:t.includes(e),children:o},o)}))})})),g=i.ZP.div`
  padding: 10px;
  border-width: 2px;
  border-style: dashed;
  border-color: rgb(255 0 0 / 0.5);
`;const b=(0,o.memo)((function(){return(0,n.jsxs)(g,{children:[(0,n.jsx)("div",{children:"Calculation is taking too long."}),(0,n.jsxs)("div",{children:["And"," ",(0,n.jsx)(s.Z,{href:"https://github.com/inker/draw/issues/14",target:"_blank",rel:"noopener",children:"here's why"}),"."]})]})}));var v=r(26962),w=r.n(v);const y=i.vJ`
  body * {
    transition-property: none !important;
    animation: none !important;
  }
`,j=r.e(2154).then(r.bind(r,16471)),Z=()=>({downloadClicked:null,transitionsEnabled:!0});const k=(0,o.memo)((function({completed:e,groupsElement:t}){const[{downloadClicked:r,transitionsEnabled:i},s]=(0,o.useState)(Z),a=(0,o.useCallback)((e=>{s({downloadClicked:e,transitionsEnabled:!1})}),[s]);(0,o.useEffect)((()=>{(async()=>{if(r){try{const e=t.current;if(!e)throw new Error("groups element is null");await w()(0);const n=await j;await n.default(e,r)}catch(e){console.error(e)}a(null)}})()}),[r]),(0,o.useEffect)((()=>{e||s({downloadClicked:null,transitionsEnabled:!0})}),[e]);const d=(0,o.useCallback)((()=>a("png")),[a]),l=(0,o.useCallback)((()=>a("svg")),[a]);return e&&t?(0,n.jsxs)("div",{children:[!i&&(0,n.jsx)(y,{}),"Download as ",(0,n.jsx)(c,{onClick:d,children:"PNG"}),", ",(0,n.jsx)(c,{onClick:l,children:"SVG"})]}):null})),P=i.ZP.div`
...
`;const T=(0,o.memo)((function({long:e,completed:t,selectedTeam:r,pickedGroup:i,possibleGroups:s,isDisplayPossibleGroupsText:a,numGroups:p,groupsElement:m,reset:h}){const f=(0,o.useRef)(null),g=(0,o.useRef)(null);(0,o.useEffect)((()=>{g.current=t?null:r}),[t,r]);const v=g.current??r;return t?(0,n.jsx)(P,{children:(0,n.jsxs)($,{children:[(0,n.jsx)("div",{children:"Draw completed!"}),(0,n.jsx)(k,{completed:t,groupsElement:m}),(0,n.jsx)(c,{onClick:h,children:"Restart"})]})}):null!==i?(f.current=(0,n.jsx)(P,{children:(0,n.jsxs)("div",{children:[e&&v?(0,n.jsxs)("span",{children:[(0,n.jsx)(E,{children:v.shortName??v.name})," goes to group"]}):(0,n.jsx)("span",{children:"Group"})," ",(0,n.jsx)(E,{children:(0,u.Z)(i)}),"!"]})}),f.current):v?(0,n.jsx)(P,{children:a?(0,n.jsxs)("div",{children:["Possible groups for"," ",(0,n.jsxs)(C,{children:[(0,n.jsx)(E,{children:v.name}),":"]}),s?(0,n.jsx)(x,{numGroups:p,possibleGroups:s}):(0,n.jsxs)("div",{children:[(0,n.jsx)(d.Z,{initialNum:0,maxNum:10,interval:2e3}),(0,n.jsx)(l,{delay:1e4,children:(0,n.jsx)(b,{})})]})]}):f.current}):(0,n.jsx)(P,{children:"Pick a ball"})}))},90604:(e,t,r)=>{"use strict";r.d(t,{Z:()=>n});const n=r(12788).ZP.div`
  display: flex;
  flex-direction: column;
  margin: 0 5px 10px;
  min-width: 35%;
...
`},78893:(e,t,r)=>{"use strict";r.d(t,{Z:()=>y});var n=r(85893),o=r(67294),i=r(12788),s=r(58020),a=r(14293),c=r.n(a);let d;var l=r(73935),u=r(12988);const p=(0,o.memo)((({tagName:e,modalRoot:t,children:r})=>{const n=(0,o.useMemo)((()=>{const t=u.includes(e)&&"svg"!==e?"http://www.w3.org/1999/xhtml":"http://www.w3.org/2000/svg";return document.createElementNS(t,e)}),[e,t]),i=(0,o.useRef)(n);return(0,o.useEffect)((()=>(t.appendChild(n),()=>{t.removeChild(n)})),[]),l.createPortal(r,i.current)})),m=((e,...t)=>{d||(d=document.createElement("style"),document.head.appendChild(d));const r=((e="")=>`${e}${Math.random().toString(36).slice(2)}`)("styled-element-"),n=((e,...t)=>e.reduce(((e,r,n)=>`${e}${r}${c()(t[n])?"":t[n]}`),""))(e,...t);return d.textContent+=`.${r}{${n}}`,r})`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
...
`},62367:(e,t,r)=>{"use strict";r.d(t,{Z:()=>E});var n=r(85893),o=r(67294),i=r(12788),s=r(91966),a=r.n(s);const c=i.ZP.div`
  display: flex;
  flex-flow: row wrap;
  flex-wrap: nowrap;
  justify-content: center;
...
`;var d=r(96026),l=r.n(d),u=r(23132),p=r(69585),m=r(42486);const h=(0,i.ZP)(m.Z)`
  transform: box-shadow 1s linear;
  ${e=>e.highlighted&&"\n\n  "}
`;var f=r(32415);const x=i.iv`
...
`,Z=(0,i.ZP)(w.Z)`
  ${e=>e.selected&&y}
  ${e=>e.picked&&j}
`;const k=(0,o.memo)((function({teams:e,pickedTeams:t,selectedTeams:r}){return(0,n.jsx)(u.Z,{children:e.map((e=>{const{name:o,country:i,shortName:s,pairing:a}=e;return(0,n.jsx)(v,{children:(0,n.jsx)(Z,{"data-cellid":e.id,title:a&&`paired with ${a.shortName??a.name}`,selected:!!r?.includes(e),picked:t.includes(e),country:i??o,children:s??o})},e.id)}))})}));const P=(0,o.memo)((function({isCurrent:e,potNum:t,teams:r,pickedTeams:o,selectedTeams:i,numCols:s,headerStyles:a}){const c=r.length/s;return(0,n.jsxs)(h,{highlighted:e,children:[(0,n.jsx)("thead",{children:(0,n.jsx)(u.Z,{children:(0,n.jsx)(p.Z,{colSpan:s,children:(0,n.jsxs)(b,{highlighted:e,depleted:!r||o.length===r.length,styles:a,children:["Pot ",t+1]})})})}),(0,n.jsx)("tbody",{children:l()(c).map((e=>{const t=e*s,a=l()(s).map((e=>r[t+e]));return(0,n.jsx)(k,{teams:a,selectedTeams:i,pickedTeams:o},a.map((e=>e.id)).join(":"))}))})]})})),C=i.iv`
  background-color: rgb(0 0 0 / 0.75);
  color: #fff;
`;const E=(0,o.memo)((function({initialPots:e,pots:t,selectedTeams:r,currentPotNum:o,split:i}){return(0,n.jsx)(c,{limitWidth:!i,children:e.map(((s,c)=>{const d=c===o,l=a()(e[c],t[c],r??[]);return(0,n.jsx)(P,{potNum:c,isCurrent:d,teams:s,pickedTeams:l,selectedTeams:r,numCols:i?2:1,headerStyles:C},s[0].id)}))})}))},36756:(e,t,r)=>{"use strict";r.d(t,{Z:()=>n});const n=r(12788).ZP.div`
  display: flex;
  flex-direction: column;
  margin: 0 5px 10px;
  min-width: 65%;
`},10804:(e,t,r)=>{"use strict";r.d(t,{Z:()=>c});var n=r(85893),o=r(67294),i=r(12788);const s=i.ZP.div`
  display: flex;
...
`;const c=(0,o.memo)((function({noHover:e,...t}){const r=(0,o.useRef)(null),i=(0,o.useCallback)((t=>{const n=r.current;!e&&n&&document.activeElement===n&&"Enter"===t.key&&n.click()}),[r,e]);var s,c;return s="keydown",c=i,(0,o.useEffect)((()=>(window.addEventListener(s,c),()=>{window.removeEventListener(s,c)})),[s,c]),(0,n.jsx)(a,{...t,noHover:e,ref:r,tabIndex:e?void 0:0})}))},55020:(e,t,r)=>{"use strict";r.d(t,{Z:()=>d});var n=r(85893),o=r(67294),i=r(12788),s=r(10804);const a=(0,i.ZP)(s.Z)`
  background:
...
`},69585:(e,t,r)=>{"use strict";r.d(t,{Z:()=>n});const n=r(12788).ZP.td`
  height: 20px;
  padding: 0;
...
`},93753:(e,t,r)=>{"use strict";r.d(t,{Z:()=>i});var n=r(12788),o=r(82376);const i=(0,n.ZP)(o.Z)`
  overflow: hidden;
  margin: 0 3px;
  text-align: left;
  text-overflow: ellipsis;
...
`},39548:(e,t,r)=>{"use strict";r.d(t,{Z:()=>a});var n=r(12788),o=r(41915),i=r(93753);const s=(0,n.ZP)(i.Z)`
  padding-left: 19px;
...
`,a=(0,n.ZP)(s)`
  ...
  `}
`},10606:(e,t,r)=>{"use strict";r.d(t,{Z:()=>i});var n=r(12788),o=r(93753);const i=(0,n.ZP)(o.Z)`
  visibility: hidden;
  pointer-events: none;
...
`},32415:(e,t,r)=>{"use strict";r.d(t,{Z:()=>i});var n=r(12788),o=r(82376);const i=(0,n.ZP)(o.Z)`
  justify-content: center;
  width: 100%;
  height: 100%;
  font-weight: 600;
  ${e=>e.styles}
`},23132:(e,t,r)=>{"use strict";r.d(t,{Z:()=>n});const n=r(12788).ZP.tr`
  border: ${e=>e.theme.border};
`},42486:(e,t,r)=>{"use strict";r.d(t,{Z:()=>n});const n=r(12788).ZP.table`
  margin: 0 5px 10px;
  width: 150px;
  min-width: 0;
  table-layout: fixed;
