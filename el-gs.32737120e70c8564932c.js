/*! For license information please see el-gs.32737120e70c8564932c.js.LICENSE.txt */
...
`;function E(e){const t=e.map(e=>o(e));return{currentPotNum:0,selectedTeam:null,pickedGroup:null,hungPot:t[0],pots:t,groups:e[0].map(()=>[])}}t.default=Object(r.memo)(({season:e,pots:t})=>{const[a,s]=Object(l.a)(),[{currentPotNum:o,selectedTeam:j,pickedGroup:O,hungPot:y,pots:P,groups:T},G]=Object(r.useState)(()=>E(t));Object(r.useEffect)(()=>{G(E(t))},[t,a]);const[,x]=Object(c.a)(),[N]=Object(u.a)(),A=Object(i.a)(w.default),C=Object(r.useRef)(null),S=Object(r.useCallback)(e=>{if(j)return;const t=P[o][e];if(!t)return;const a=P.slice();a[o]=a[o].filter((t,a)=>a!==e),G({currentPotNum:o,hungPot:y,selectedTeam:t,pickedGroup:null,pots:a,groups:T})},[P,T,o,y,j]);Object(r.useEffect)(()=>{j&&(async()=>{if(!j)throw new Error("no selected team");let t;try{t=(await A({season:e,pots:P,groups:T,selectedTeam:j})).pickedGroup}catch(e){return console.error(e),void x({error:"Could not determine the group"})}const a=T.slice();a[t]=[...a[t],j];const r=P[o].length>0?o:o+1;G({selectedTeam:null,pickedGroup:t,hungPot:P[r],currentPotNum:r,pots:P,groups:a})})()},[j]);const M=o>=P.length,I=T.length,W=Object(r.useCallback)(e=>e<I>>1?k:v,[I]);return n.a.createElement(g.a,null,n.a.createElement(p.a,null,n.a.createElement(m.a,{selectedTeams:j&&[j],initialPots:t,pots:P,currentPotNum:o}),n.a.createElement(d.a,{ref:C,maxTeams:P.length,currentPotNum:o,groups:T,possibleGroups:null,getGroupHeaderStyles:W})),n.a.createElement(b.a,null,n.a.createElement(h.a,{forceNoSelect:!!j,display:!M,displayTeams:N,selectedTeam:j,pot:y,onPick:S}),n.a.createElement(f.a,{long:!0,completed:M,selectedTeam:j,pickedGroup:O,possibleGroups:null,isDisplayPossibleGroupsText:!!j,numGroups:I,groupsElement:C,reset:s})))})},95:function(e,t,a){"use strict";a.r(t),t.default=function(){return new Worker(a.p+"worker.7183f99cec5bacceb968.worker.js")}}},0,[80]]);