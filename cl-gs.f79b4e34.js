...
`;function N(e){let r=e.map(e=>(0,i.Z)(e)),l=r[0];return{currentPotNum:0,selectedTeam:null,pickedGroup:null,hungPot:l,possibleGroups:null,possibleGroupsShuffled:null,pots:r,groups:e[0].map(()=>[])}}let T=(0,o.memo)(function({season:e,pots:r,isFirstPotShortDraw:l}){let[t,k]=(0,c.Z)(),[j,w]=(0,d.Z)(),[{currentPotNum:$,selectedTeam:T,pickedGroup:D,hungPot:M,possibleGroups:S,possibleGroupsShuffled:F,pots:R,groups:A},L]=(0,o.useState)(()=>N(r));(0,o.useEffect)(()=>{L(N(r))},[r,t]);let[,U]=(0,u.Z)(),[W]=(0,p.Z)(),H=(0,f.Z)(C),I=(0,f.Z)(y),V=(0,o.useRef)(null),q=l&&0===$,z=j||q,B=async()=>{let r;if(!T)throw Error("no selected team");try{if(q){let l=await H({season:e,pots:R,groups:A,selectedTeam:T});r=[l.pickedGroup]}else{let l=await I({season:e,pots:R,groups:A,selectedTeam:T});r=l.possibleGroups}}catch(e){console.error(e),U({error:"Could not determine the group"});return}L({selectedTeam:T,pickedGroup:null,hungPot:M,currentPotNum:$,possibleGroups:r,possibleGroupsShuffled:(0,i.Z)(r),pots:R,groups:A})},J=(0,o.useCallback)(e=>{if(T)return;let r=R[$][e];if(!r)return;let l=R.slice();l[$]=l[$].filter((r,l)=>l!==e),L({currentPotNum:$,hungPot:M,selectedTeam:r,possibleGroups:S,possibleGroupsShuffled:F,pickedGroup:null,pots:l,groups:A})},[R,A,$,M,T,S,F]),K=(0,o.useCallback)(e=>{if(!T){U({error:"No selected team..."});return}let r=A.slice();r[e]=[...r[e],T];let l=R[$].length>0?$:$+1;L({selectedTeam:null,pickedGroup:e,hungPot:R[l],possibleGroups:null,possibleGroupsShuffled:null,currentPotNum:l,pots:R,groups:r})},[R,A,T,$,M]);(0,o.useEffect)(()=>{T&&B()},[T]);let O=$>=R.length;(0,o.useEffect)(()=>{let e=M?.length;if(j&&e){let r=(0,n.Z)(e-1);J(r)}},[j,M]),(0,o.useEffect)(()=>{if(z&&F?.length){let e=q?Math.min(...F):(0,a.Z)(F);K(e)}},[z,F]),(0,o.useEffect)(()=>{O&&j&&w(!1)},[O,j]);let Q=A.length,X=(0,o.useCallback)(e=>e<Q>>1?P:E,[Q]);return(0,s.jsxs)(m.Z,{children:[(0,s.jsxs)(x.Z,{children:[(0,s.jsx)(h.Z,{selectedTeams:T&&[T],initialPots:r,pots:R,currentPotNum:$}),(0,s.jsx)(b.Z,{ref:V,maxTeams:R.length,currentPotNum:$,groups:A,possibleGroups:z?null:S,getGroupHeaderStyles:X})]}),(0,s.jsxs)(g.Z,{children:[!j&&(0,s.jsx)(Z.Z,{display:!O,displayTeams:W,selectedTeam:T,pot:M,onPick:J}),(0,s.jsx)(v.Z,{long:!1,completed:O,selectedTeam:T,pickedGroup:D,possibleGroups:j?null:S,isDisplayPossibleGroupsText:!!T,numGroups:Q,groupsElement:V,reset:k}),!z&&(0,s.jsx)(G,{display:!O,displayGroups:W,possibleGroups:F,onPick:K})]})]})})},80528:(e,r,l)=>{l.d(r,{Z:()=>P});var s=l(85893),o=l(67294),t=l(70394),i=l(40726),n=l(46202),a=l(48606),u=l(1850),c=l(8360),d=l(90595),p=l(63835),f=l(63494),m=l(79633),h=l(88834),b=l(43955);let x=(0,t.F4)`
  from {
...
`,$=(0,t.ZP)(c.Z)`
  ${e=>e.$possible&&j}
  ${e=>e.$picked&&w}
`,G=(0,o.memo)(function({team:e,possible:r}){let l=(0,d.Z)(e),[i,n]=(0,o.useState)(e),[a,u]=(0,o.useState)(!1),c=(0,o.useContext)(t.Ni),x=(0,o.useRef)(null),g=(0,o.useCallback)(()=>u(!1),[]),Z=(0,o.useCallback)(()=>{n(e),u(!0)},[e]);return(0,p.Z)(()=>{g()},[c]),(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)($,{$picked:a&&!!i,$possible:r,onAnimationEnd:g,children:i?(0,s.jsx)(m.Z,{$country:(0,f.Z)(i),children:i.shortName??i.name}):(0,s.jsx)(h.Z,{ref:x})}),e&&e!==l&&(0,s.jsx)(b.Z,{from:`[data-cellid='${e.id}']`,to:x,duration:350,team:e,onAnimationEnd:Z})]})}),v=(0,o.memo)(function({maxTeams:e,groupLetter:r,teams:l,potNum:o,possible:t,headerStyles:i}){return(0,s.jsxs)(n.Z,{children:[(0,s.jsx)("thead",{children:(0,s.jsx)(u.Z,{children:(0,s.jsx)(c.Z,{children:(0,s.jsxs)(a.Z,{$styles:i,children:["Group"," ",r]})})})}),(0,s.jsx)("tbody",{children:Array.from({length:e},(e,r)=>(0,s.jsx)(u.Z,{children:(0,s.jsx)(G,{team:l[r],possible:r===o&&t})},r))})]})}),y=t.ZP.div`
  display: flex;
  flex-flow: row wrap;
