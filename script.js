...
function fetchPots(url) {
    return fetch("https://proxy-antonv.rhcloud.com/?url=" + encodeURIComponent(url) + "&encoding=latin1")
        ...
        .catch(function (err) { return alert('Proxies are down. Refreshing the page may help.'); });
}
exports.fetchPots = fetchPots;
function parseGS(body) {
    return fetch('json/pairings.json')
        .then(function (response) { return response.json(); })
        .then(function (pairings) { return pairUpTeams(parseGSTeams(body), pairings); })
...
function parseLast16Teams(data) {
    ...
    var pots = [[], []];
    var re = /\s*(.+?)(\s\*+\d?|\([CE]L-TH\)?\s+)?\s{2,}(\w{3})\s+/g;
    var matches;
...
function pairUpTeams(teams, pairStr) {
    for (var _i = 0, pairStr_1 = pairStr; _i < pairStr_1.length; _i++) {
        var str = pairStr_1[_i];
...
},{"./team":7}],2:[function(require,module,exports){
"use strict";
...
},{"../util":8,"../visualizer":9,"./possible-groups":3}],3:[function(require,module,exports){
"use strict";
...
var Last16DrawVisualizer = (function (_super) {
    ...
    Last16DrawVisualizer.prototype.fillBowl = function (potNumber, possibleOpponents) {
        ...
        for (var _i = 0, shuffledIndices_1 = shuffledIndices; _i < shuffledIndices_1.length; _i++) {
            var i = shuffledIndices_1[_i];
            var ball = document.createElement('div');
            ball.classList.add('ball');
            ball.textContent = pot[i].name;
            ball.dataset['team'] = i.toString();
...
},{"../util":8,"../visualizer":9,"./last16":5}],5:[function(require,module,exports){
"use strict";
...
var modes = [
    ...
    { url: 'last16', name: 'Last 16 draw', disabled: false }
];
var currentMode = location.search.endsWith('mode=gs') ? 0 : 1;
function checkMode() {
...
function start() {
    checkMode();
    history.pushState({}, '', '?mode=' + modes[currentMode].url);
...
},{"./fetch-parse-pots":1,"./gs/draw-visualizer":2,"./last16/draw-visualizer":4}],7:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
var GSTeam = (function (_super) {
    ...
    function GSTeam(name, country, coefficient, pairing) {
        var _this = _super.call(this, name, country) || this;
