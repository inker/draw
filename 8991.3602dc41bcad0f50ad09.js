...
`},78893:(e,t,r)=>{"use strict";r.d(t,{Z:()=>w});var n=r(85893),o=r(67294),i=r(12788),s=r(58020),a=r(14293);let c;var d=r(73935),l=r(12988);const u=(0,o.memo)((({tagName:e,modalRoot:t,children:r})=>{const n=(0,o.useMemo)((()=>{const t=l.includes(e)&&"svg"!==e?"http://www.w3.org/1999/xhtml":"http://www.w3.org/2000/svg";return document.createElementNS(t,e)}),[e,t]),i=(0,o.useRef)(n);return(0,o.useEffect)((()=>(t.appendChild(n),()=>{t.removeChild(n)})),[]),d.createPortal(r,i.current)})),p=((e,...t)=>{c||(c=document.createElement("style"),document.head.appendChild(c));const r=((e="")=>`${e}${Math.random().toString(36).slice(2)}`)("styled-element-"),n=((e,...t)=>e.reduce(((e,r,n)=>`${e}${r}${a(t[n])?"":t[n]}`),""))(e,...t);return c.textContent+=`.${r}{${n}}`,r})`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
  ...
  z-index: 1000;
  pointer-events: none;
`,m=document.createElement("div");m.classList.add(p),document.body.insertBefore(m,document.getElementById("app"));const h=(0,o.memo)((function({children:e}){return(0,n.jsx)(u,{tagName:"div",modalRoot:m,children:e})}));var f=r(39548);const x=(0,i.ZP)(f.Z)`
  position: fixed;
  top: 0;
  left: 0;
  z-index: 1000;
  ...
  user-select: none;
  pointer-events: none;
`,g=e=>"string"==typeof e?document.querySelector(e):e.current,b=e=>`transform ${e}ms ease-in-out`;function v(e){const{left:t,top:r}=e.getBoundingClientRect();return`translate3d(${t}px, ${r}px, 0px)`}const w=(0,o.memo)((function({from:e,to:t,duration:r,team:i,onAnimationEnd:a}){const c=(0,o.useMemo)((()=>g(e)),[e]),d=(0,o.useMemo)((()=>g(t)),[t]),[l,u]=(0,o.useState)(c);(0,o.useLayoutEffect)((()=>{l===c&&u(d)}),[l]);const p=(0,o.useMemo)((()=>({transform:l instanceof HTMLElement?v(l):"",transition:l===d?b(r):""})),[l,d,r]),m=(0,o.useCallback)((e=>{"transform"===e.propertyName&&a?.()}),[a]);return l&&(0,n.jsx)(h,{children:(0,n.jsx)(x,{country:(0,s.Z)(i),style:p,onTransitionEnd:m,children:i.shortName??i.name})})}))},85973:(e,t,r)=>{"use strict";r.d(t,{Z:()=>n});const n=r(12788).ZP.div`
  display: flex;
  margin: auto;
  width: 1000px;
...
`},62367:(e,t,r)=>{"use strict";r.d(t,{Z:()=>P});var n=r(85893),o=r(67294),i=r(12788),s=r(91966);const a=i.ZP.div`
  display: flex;
  flex-flow: row wrap;
  flex-wrap: nowrap;
  justify-content: center;
