...
`;const T=(0,t.memo)((function({display:e,displayGroups:s,possibleGroups:o,onPick:n}){const l=(0,t.useCallback)((e=>{const s=e.target,o=+s.dataset.group;if(Number.isNaN(o))throw new TypeError(`Incorrect group ball: ${s.dataset.group}`);n(o)}),[n]);return(0,r.jsx)(v,{children:e&&o?.map((e=>(0,r.jsx)(y,{"data-group":e,forceVisible:s,onClick:l,children:(0,j.Z)(e)},e)))})}));var N=o(3447);const S=()=>new Worker(new URL(o.p+o.u(4069),o.b)),C=()=>new Worker(new URL(o.p+o.u(6356),o.b)),$=n.iv`
  background-color: ${e=>e.theme.isDarkMode?"#933":"#ffc0c0"};
`,E=n.iv`
  background-color: ${e=>e.theme.isDarkMode?"#039":"#c0e0ff"};
`;function D(e){const s=e.map((e=>p()(e)));return{currentPotNum:0,selectedTeam:null,pickedGroup:null,hungPot:s[0],possibleGroups:null,possibleGroupsShuffled:null,pots:s,groups:e[0].map((()=>[]))}}const M=(0,t.memo)((function({season:e,pots:s,isFirstPotShortDraw:o}){const[n,l]=(0,m.Z)(),[a,c]=(0,f.Z)(),[{currentPotNum:j,selectedTeam:P,pickedGroup:y,hungPot:v,possibleGroups:M,possibleGroupsShuffled:F,pots:R,groups:L},H]=(0,t.useState)((()=>D(s)));(0,t.useEffect)((()=>{H(D(s))}),[s,n]);const[,A]=(0,d.Z)(),[U]=(0,h.Z)(),W=(0,b.Z)(C),I=(0,b.Z)(S),V=(0,t.useRef)(null),q=o&&0===j,z=a||q,B=(0,t.useCallback)((e=>{if(P)return;const s=R[j][e];if(!s)return;const o=R.slice();o[j]=o[j].filter(((s,o)=>o!==e)),H({currentPotNum:j,hungPot:v,selectedTeam:s,possibleGroups:M,possibleGroupsShuffled:F,pickedGroup:null,pots:o,groups:L})}),[R,L,j,v,P,M,F]),J=(0,t.useCallback)((e=>{if(!P)return void A({error:"No selected team..."});const s=L.slice();s[e]=[...s[e],P];const o=R[j].length>0?j:j+1;H({selectedTeam:null,pickedGroup:e,hungPot:R[o],possibleGroups:null,possibleGroupsShuffled:null,currentPotNum:o,pots:R,groups:s})}),[R,L,P,j,v]);(0,t.useEffect)((()=>{P&&(async()=>{if(!P)throw new Error("no selected team");let s;try{s=q?[(await W({season:e,pots:R,groups:L,selectedTeam:P})).pickedGroup]:(await I({season:e,pots:R,groups:L,selectedTeam:P})).possibleGroups}catch(e){return console.error(e),void A({error:"Could not determine the group"})}H({selectedTeam:P,pickedGroup:null,hungPot:v,currentPotNum:j,possibleGroups:s,possibleGroupsShuffled:p()(s),pots:R,groups:L})})()}),[P]);const K=j>=R.length;(0,t.useEffect)((()=>{const e=v?.length;if(a&&e){const s=u()(e-1);B(s)}}),[a,v]),(0,t.useEffect)((()=>{if(z&&F?.length){const e=q?Math.min(...F):i()(F);J(e)}}),[z,F]),(0,t.useEffect)((()=>{K&&a&&c(!1)}),[K,a]);const O=L.length,Q=(0,t.useCallback)((e=>e<O>>1?$:E),[O]);return(0,r.jsxs)(g.Z,{children:[(0,r.jsxs)(Z.Z,{children:[(0,r.jsx)(x.Z,{selectedTeams:P&&[P],initialPots:s,pots:R,currentPotNum:j}),(0,r.jsx)(k.Z,{ref:V,maxTeams:R.length,currentPotNum:j,groups:L,possibleGroups:z?null:M,getGroupHeaderStyles:Q})]}),(0,r.jsxs)(G.Z,{children:[!a&&(0,r.jsx)(w.Z,{display:!K,displayTeams:U,selectedTeam:P,pot:v,onPick:B}),(0,r.jsx)(N.Z,{long:!1,completed:K,selectedTeam:P,pickedGroup:y,possibleGroups:a?null:M,isDisplayPossibleGroupsText:!!P,numGroups:O,groupsElement:V,reset:l}),!z&&(0,r.jsx)(T,{display:!K,displayGroups:U,possibleGroups:F,onPick:J})]})]})}))},3962:(e,s,o)=>{o.d(s,{Z:()=>C});var r=o(85893),t=o(67294),n=o(12788),l=o(788),u=o(96026),a=o.n(u),i=o(42486),c=o(32415),p=o(23132),d=o(69585),m=o(84048),f=o(41771),h=o(58020),b=o(39548),g=o(10606),x=o(10694);const k=n.F4`
  from {
